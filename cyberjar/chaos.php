...
<html>
    <head>
        ...
        <link rel="stylesheet" href="c.css?<?php echo time(); ?>">
    </head>
    <body>
        <div id="game" class="container-fluid unselectable">
            <div class="row">
                <div class="col-xs-12">
                    <h1 style="color:orange">Cyber.jar</h1>
                    <p  style="color:#004de6" id="notif">Tap any operator to begin.</p>
                </div>
                <div class="col-xs-6">
                    <input id="name1" type="text" value="Player 1" style="width:100%; margin-bottom:10px;"/>
                ...
                <div class="col-xs-6">
                    <input id="name2" type="text" value="Player 2" style="width:100%; margin-bottom:10px;"/>
            ...
            <footer class="footer">
                <div class="container-fluid infobox" style="margin-top: 50px; text-align:center;">
                    ...
                    Theme: <span onclick="location.href='index.php'"><i>Basic</i></span> / <span onclick="location.href='cbj.php'"><i>Cyber Jar</i></span> / <span onclick="location.href='be.php'"><i>Blue Eyes</i></span> / <span style="font-weight:200; cursor: default;"><i>Chaos</i></span><br/>
