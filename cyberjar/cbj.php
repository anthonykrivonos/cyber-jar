...
<html>
    <head>
        ...
        <link rel="stylesheet" href="cbj.css?<?php echo time(); ?>">
    </head>
    <body style="background-color:black;">
        <div id="game" class="container-fluid unselectable">
            <div class="row">
                <div class="col-xs-12">
                    <h1 style="-webkit-text-stroke-width: 1px; color:white;">Cyber.jar</h1>
            ...
            <footer class="footer">
                <div class="container-fluid" style="margin-top: 50px; text-align:center; color:white;">
                    ...
                    Theme: <span onclick="location.href='index.php'"><i>Basic</i></span> / <span style="font-weight:200; cursor: default;"><i>Cyber Jar</i></span> / <span onclick="location.href='be.php'"><i>Blue Eyes</i></span> / <span onclick="location.href='chaos.php'"><i>Chaos</i></span><br/>
