    ...
    <body>
        <div id="game" class="container-fluid unselectable">
            <div class="row">
                <div class="col-xs-12">
                    <h1>Cyber.jar</h1>
                    <p id="notif">Tap any operator to begin.</p>
                </div>
                <div class="col-xs-6">
            ...
            <footer class="footer">
                <div class="container-fluid" style="margin-top: 50px; text-align:center;">
                    ...
                    Theme: <span style="font-weight:200; cursor: default;"><i>Basic</i></span> / <span onclick="location.href='cbj.php'"><i>Cyber Jar</i></span> / <span onclick="location.href='be.php'"><i>Blue Eyes</i></span> / <span onclick="location.href='chaos.php'"><i>Chaos</i></span><br/>
